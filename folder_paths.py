...
supported_text_encoder_extensions: set[str] = supported_pt_extensions | {
...
folder_names_and_paths["mlx"] = ([os.path.join(models_dir, "mlx")], {"folder"})
folder_names_and_paths["mlx_ltx"] = ([os.path.join(models_dir, "mlx_ltx")], {"folder"})
folder_names_and_paths["gguf"] = ([os.path.join(models_dir, "gguf")], {"folder"})
folder_names_and_paths["transformers"] = ([os.path.join(models_dir, "transformers")], {"folder"})
